    ...
    <div class="container">
        <div class="row">
            <div class="col-12 d-flex justify-content-center">
                <h1 class="main_heading_content">Demat</h1>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-md-6 mb-5 col-lg-4 col-sm-12 col-xs-12">
                <!-- <a href="" style="color: #000 !important;"> -->
                    <div class="card main_card border-0" style="height:450px;padding:20px;">
                        <img src="{{\App\Models\Bank::IMAGE_URL.$demat->bank->logo}}" class="card-img-top" alt="..." style="min-height:100px;max-height:100px;padding:20px">
                        <div class="card-body" style="height: 100%;">
                           <table class="table table-responsive">
                           		<thead>
                           			<tr>
                           				<th colspan="2">{{$demat->name}}</th>
                           			</tr>
                           		</thead>
                           		<tbody>
                           			<tr>
                        ...
                        <div class="row">
                        	<div class="col-6">
                        		<button class="btn btn-primary-gradient_red rounded-pill animated slideInLeft details" data-href="{{route('demat.details',[base64_encode($demat->id)])}}" style="border:1px solid #acd2f1;white-space:nowrap;">More Details</button>
                        	</div>

    ...
    <div class="container">
        <div class="row">
            <div class="col-12 d-flex justify-content-center">
                <h1 class="main_heading_content">{{$demat->name}}</h1>
            </div>
        </div>
    </div>
</section>
  ...
  <div class="container pt-lg-4">
      ...
      <div class="card-box rounded shadow-sm border py-4 px-4">
        <div class="row align-items-center">
            ...
            <!-- <h5 class="text-center">{{$demat->name}}</h5> -->
            <div class="col-lg-10">
                <div class="row mt-4 flex-row-reverse">
                    <div class="col-lg-3 text-center p-1">
                        <h6 class="text-sm">Exchange</h6>
                        <p class="text-danger text-sm mt-1">{{$demat->exchange}}</p>
                    </div>
                    <div class="col-lg-3 text-center p-1">
                        <h6 class="text-sm">Trading Account Opening Fee</h6>
                        <p class="text-danger text-sm mt-1">{{$demat->trading_account_opening_fee}}</p>
                    </div>
                    <div class="col-lg-3 text-center p-1">
                        <h6 class="text-sm">Demat Account Opening Fee
                        </h6>
                        <p class="text-danger text-sm mt-1">{{$demat->demat_account_opening_fee}}</p>
                    </div>
                    <div class="col-lg-3 text-center p-1">
             ...
             <div class="col-lg-2 mt-3 mt-md-0 text-center text-md-start">
                <img src="{{\App\Models\Bank::IMAGE_URL.$demat->bank->logo}}" class="img-fluid" width="160" height="58" alt="img">
            </div>
        </div>
    </div>
